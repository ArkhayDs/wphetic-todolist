...
export default function Form({setCards,limiter}) {
    ...
    function handleSubmit(e) {
        ...
        if (formTitle !== "" && formContent !== "") {
            ...
            if(limiter === false) {
                ...
                window.alert("Wowowo, tout doux bijou. Tu as déjà 10 cartes de to-do à faire. Tu penses pas qu'il serait temps de s'y mettre d'abord ?");
            }
        }
    }
    ...
    return (
        <form className="m-5 mx-auto" style={{maxWidth: '450px'}} onSubmit={handleSubmit}>
            ...
            <HandleButton customClass="btn-primary" text="Submit" id>Submit</HandleButton>
        </form>
    )
}